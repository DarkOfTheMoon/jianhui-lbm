...
plot "$1prosity_output.dat_sta2" u 1:2  w l title "Sandard deviation of subdomians with different sizes"
...
"$1prosity_output.dat_sub" title "subdomains with increasing sizes"
